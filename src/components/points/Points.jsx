    ...
    >
      <ul>
        ...
        >
          ...
          <div>
          저는 <span className='text-bold' >일정 준수를 중요한 업무 역량</span>으로 여깁니다. 결과물이 일정에 맞추어 준비되면, 필요 시 추가 논의를 통해 퀄리티를 높이거나 새로운 방향성을 모색할 수 있습니다. 반대로, 일정을 지키지 않는 것은 문제를 숨기고 키울 가능성이 크며, 프로젝트의 리스크로 작용할 수 있습니다.
          </div>
        </li>
        ...
        >
          ...
          <div>
          여러 프로젝트를 수행하면서, <span className='text-bold'>팀원들이 저를 편안하게 느끼고 쉽게 다가오는 경험</span>을 많이 했습니다. 특히, 최근 진행했던 컨퍼런스 프로젝트에서는 웹 페이지 제작팀과 Discord에서 gif와 meme을 활용하여 소통함으로써 팀원들이 저를 더 빠르게 친숙하게 느낄 수 있었다는 피드백을 받았습니다.
          </div>
        </li>
        ...
        >
          ...
          <div>
          SI 프로젝트 매니저로서 일하며 개발에 대한 흥미를 가지게 됐습니다. <span className='text-bold' > 1년 동안 직접 아이디어를 구현하여 실제로 개발해 보면서 작동하는 것을 보는 과정</span>에서 큰 보람을 느꼈습니다. 이 경험은 단순히 그림으로 그려진 개념을 넘어, 실제로 구현되는 과정을 이해하게 해주었고, 이를 통해 개발자와 사용자 간의 간극을 더 명확히 인식하게 되었습니다.
          </div>
        </li>
