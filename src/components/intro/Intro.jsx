  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="intro-slogan-text">Human-AI Interaction</span><span className="intro-slogan-text-sm">(Intepreter)</span>
      </div>
      <div className="intro-text">
        매니징을 해보니, 작은 UI/UX의 변화만으로 고객과 사용자가 변화하는 모습을 보고 궁금증을 갖고 2023년부터 프론트 개발 공부를 시작했습니다.
      </div>
